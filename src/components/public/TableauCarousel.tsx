...
import dayAbbreviations from "../../utils/dayAbbreviations.ts";
import monthAbbreviations from "../../utils/monthAbbreviations.ts";
    ...
    return (
        <div className={"flex justify-between items-center py-4 px-32 h-16 fixed inset-x-0 top-20 bg-surface-200-800"}>
            ...
            {dateList.map((date, index) => (
                <p key={date.toDateString()} className={`${index === 6 ? 'font-bold' : 'hover:font-bold hover:cursor-pointer'} min-w-24 text-center`}>
